...
at::Tensor dcn3Dv3_forward(const at::Tensor &input, const at::Tensor &offset,
...
#ifdef WITH_CUDA
        return dcn3Dv3_cuda_forward(input, offset, mask, kernel_h, kernel_w,
...
dcn3Dv3_backward(const at::Tensor &input, const at::Tensor &offset,
    ...
    if (input.type().is_cuda()) {
#ifdef WITH_CUDA
        return dcn3Dv3_cuda_backward(input, offset, mask, kernel_h, kernel_w,
                                   stride_h, stride_w, pad_h, pad_w, dilation_h,
                                   dilation_w, group, group_channels,
